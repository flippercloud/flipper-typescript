...
export default class Failsafe implements IAdapter {
  ...
  async add(feature: Feature): Promise<boolean> {
    try {
      return await this.adapter.add(feature)
    } catch (error) {
      if (this.shouldCatch(error)) {
        return false
      }
  ...
  async remove(feature: Feature): Promise<boolean> {
    try {
      return await this.adapter.remove(feature)
    } catch (error) {
      if (this.shouldCatch(error)) {
        return false
      }
  ...
  async clear(feature: Feature): Promise<boolean> {
    try {
      return await this.adapter.clear(feature)
    } catch (error) {
      if (this.shouldCatch(error)) {
        return false
      }
  ...
  async enable(feature: Feature, gate: IGate, thing: IType): Promise<boolean> {
    try {
      return await this.adapter.enable(feature, gate, thing)
    } catch (error) {
      if (this.shouldCatch(error)) {
        return false
      }
  ...
  async disable(feature: Feature, gate: IGate, thing: IType): Promise<boolean> {
    try {
      return await this.adapter.disable(feature, gate, thing)
    } catch (error) {
      if (this.shouldCatch(error)) {
        return false
      }
